          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 p-4">
              <p className="text-xs text-gray-600">
                By submitting this form, you consent to us collecting your name and phone number to facilitate
                pet reunification. We also collect your IP address and browser information to prevent spam.
